        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-10">
          <div className="lg:max-w-md">
            <p className="text-5xl font-bold">
              <span className="theme-text "> Our Banking &</span> <br></br>{" "}
              Partner Network
            </p>
            <p className="text-gray-600 mt-4 text-base leading-relaxed  font-medium">
              At vero eos et accusamus et iusto odio dignissimos ducimus odio
              dignissimos ducimus At vero eos et accusamus et iusto odio
              dignissimos ducimus odio dignissimos ducimus
            </p>
          </div>
          ...
          <div className="w-full grid grid-cols-2  md:grid-cols-4 gap-6">
            {partnerLogos.map((logo, i) => (
              <div
                key={i}
                className={`group relative w-32 h-24 shadow-[0_4px_30px_rgba(228,237,243,1)] rounded-lg bg-white transition-all duration-500 hover:bg-[#2E709B] flex items-center justify-center float-animate ${
                  i % 2 === 0 ? "mt-0" : "mt-10"
                }`}
                style={{
