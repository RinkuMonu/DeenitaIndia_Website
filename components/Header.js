  ...
  return (
    <>
      ...
      <nav className={`fixed left-0 w-full z-[9999] transition-all duration-500 ${scrolled ? "bg-white/90  shadow-xl" : "px-4"}`}>
        ...
        {/* Main Navigation */}
        <div className={`flex items-center justify-between rounded-b-xl px-4 md:px-6 py-3 backdrop-blur-xl transition-all duration-500 ${scrolled ? "bg-white/90 top-0 mx-0 shadow-xl rounded-none" : "bg-white rounded-none shadow-md  top-12 "}`}>
    ...
    >
      ...
      >
        ...
        <form className="space-y-4">
          ...
          {/* <div className="flex items-center justify-between text-sm text-gray-500">
            <label className="flex items-center gap-2">
              <input type="checkbox" className="h-4 w-4 text-[#115d8e] rounded" />
              Remember sign-in details
            </label>
            <a href="/forgot-password" className="hover:text-[#0E90C9]">Forget password?</a>
          </div> */}
        ...
        {/* <p className="text-sm text-gray-500 mt-4 text-center">
          ...
          <a href="/register" className="text-[#115d8e] hover:text-[#0E90C9] font-medium">
            Register
          </a>
        </p> */}
      </motion.div>
