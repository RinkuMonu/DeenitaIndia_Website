                ...
                <div className='container'>
                    ...
                    <div className="flex flex-col lg:flex-row w-full pt-10">
                        {blogPosts.map((post, index) => (
                            <div
                                key={index}
                                className="group transition-all duration-500 ease-in-out transform-gpu  
                 w-full lg:basis-1/3 lg:hover:basis-[44%] lg:hover:z-10 "
                            >
                                <div className=" p-2">
                                    <Image
                                        ...
                                        width={600}
                                        height={600}
                                        className="w-full h-auto rounded-xl border-transparent border transition-all duration-300 group-hover:border-3 group-hover:border-[#115D8E]"
                                        alt="blog image"
                                    />
                                 <div className='px-2'>
                     ...
                     line-clamp-1 lg:group-hover:line-clamp-none transition-all duration-500"
                                    >
                                        {post.title}
                                    </h3>
                                    <p
                                        className="text-gray-500  text-sm mb-5 max-h-0 opacity-0 overflow-hidden transition-all duration-500
                     lg:group-hover:max-h-40 lg:group-hover:opacity-100"
                                    ...
                                    <Link
                                        href={post.url}
                                        className="inline-flex items-center text-xs p-1 shadow-[0_4px_30px_rgba(138,173,187)]  rounded-lg text-white bg-[#115D8E] transition-colors mt-auto"
                                    >
                                        Read more <MdArrowOutward className="ml-2 text-bold" />
                                    </Link>
                                    </div>
                                </div>
                            </div>
