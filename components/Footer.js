...
function Footer() {
  ...
  <footer className="relative shadow-[1px_-2px_4px_0px_#00000040]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0">
              <div className="lg:pl-10">
                ...
                <div className="flex gap-4 mt-6">
                  <Link  href="" className="text-gray-600 hover:text-[#1476ad] transition-colors">
                    <FaInstagram size={24} />
                  </Link>
                  <Link href="" className="text-gray-600 hover:text-[#1476ad] transition-colors">
                    <FaFacebook size={24} />
    ...
    <li><Link href="/services/switch" className="hover:text-[#0E91C9]">Switch Service</Link></li>
    <li><Link href="/services/escrow" className="hover:text-[#0E91C9]">Escrow Service</Link></li>
    <li><Link href="/services/connected-banking" className="hover:text-[#0E91C9]">Connected Banking</Link></li>
    <li><Link href="/services/aigf" className="hover:text-[#0E91C9]">AIGF License Assistance</Link></li>
    <li><Link href="/services/legal-compliance" className="hover:text-[#0E91C9]">Legal & Compliance Services</Link></li>
    <li><Link href="/services/utility" className="hover:text-[#0E91C9]">Utility Services</Link></li>
  </ul>
              </div>
              ...
              <div className='mt-10 md:mt-0'>
                ...
                <div className="space-y-4 text-sm">
                  ...
                  <div className='flex items-start'>
                    ...
                    <p className="pl-3">support@7unique.in</p>
                  </div>
                   <div className='flex items-start'>
                    <IoMail className='text-xl text-[#0E91C9] mt-1' />
                    <p className="pl-3">info@7unique.in</p>
                  </div>
                  <div className='flex items-start'>
                    <IoMdCall className='text-xl text-[#0E91C9] mt-1' />
                    <p className="pl-3">0141-4511098</p>
                  </div>
                </div>
              </div>
            </div>
